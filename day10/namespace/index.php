...
<body>
<h1>Namespace (Không gian tên)
Giải quyết vấn đề chùng tên class  hoặc tên hàng trong PHP</h1>


<pre>
     khi 1 file không khai báo nammespace như file index.php này thì được
    coi như nó đang ở trong GLOBAL NAMESPACE
     Để sử dụng được class  trong namespace khác thì sẽ phải import namespace đó
    vào file hiện tại
